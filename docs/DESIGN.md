...
Repeater Atlas is a new project with an initial design to be defined. This
document captures the intended purpose, scope, requirements, and a starting
architecture to align on direction before implementation.
